...
//trituradora receta
event.custom({"type":"minecraft:crafting_shaped","key":{"B":{"item":"minecraft:lava_bucket"},"C":{"tag":"forge:circuits/basic"},"R":{"tag":"forge:dusts/redstone"},"X":{"item":"industrialforegoing:machine_frame_advanced"}},"pattern":["RCR","BXB","RCR"],"result":{"item":"mekanism:crusher"}})
